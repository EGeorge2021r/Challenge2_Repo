...
"""
import sys
# import fire installed properly
import fire
...
# the user finds which loans the the applicant qualifies for based on the criteria defined 
...
# the qualifying loans file is now saved in csv 
def save_csv(qualifying_loans):
    ...
    # with the correct path entered by the user, the filtered qualifying loans is now written as csv file
    with open(ans_path, "w",newline="") as csvfilew:
        ...
        # look through inexpensive loans list and write to the file
...
def save_qualifying_loans(qualifying_loans):
    ...
    # YOUR CODE HERE!
    # Using questionary, the user is asked to confirm if he wants the result of the qualifying loans to be save
