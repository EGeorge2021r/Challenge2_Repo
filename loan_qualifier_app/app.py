...
def save_qualifying_loans(qualifying_loans):
    ...
    # YOUR CODE HERE!
    # Using questionary, ask the question
    ans_savefile = questionary.confirm("Do you want to save this file?").ask()
    if ans_savefile == True:
        save_csv(qualifying_loans) 
    # My_answer = questionary.confirm("Do you want to save this file?").ask()
    #My_path = questionary.path("Path to the projects version file").ask()
